...
import unittest
import sys
sys.path.append(r"D:\IdeaProjects\seeyon\cap+\Interfaces\Logins") #跨目录调用需要配置路径,接口路径
import Login
sys.path.append(r"D:\IdeaProjects\seeyon\cap+\Common") #跨目录调用需要配置路径,接口路径
import DataBases,file
sys.path.append(r'D:\IdeaProjects\seeyon\cap+\TestDatas') #跨目录调用需要配置路径
