...
class excelprocess_xl():
    ...
    # 读取工作簿中的数据
    def read_excel_xls(self, path, sheet_name="", style=1, row=1, col=1):
        """
        :param path:
        :param sheet_name:
        """
        ...
        # 读取指定位置的值
            ...
            value= worksheet.cell_value(row-1, col-1)
            return value
...
if __name__ == "__main__":
    ...
    print(type(position.excel_dataposition(filepath, sheetname, value)))
    print(position.excel_dataposition(filepath, sheetname, value))
